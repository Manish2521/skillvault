...
{/*                 <User className="w-5 h-5 text-blue-600 dark:text-blue-400" /> */}
              ...
              <>
                <Link
                  ...
                  focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center 
                  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center gap-1"
                >
                  <FaSignInAlt /> Login
                </Link>
                <Link
                  to="/signup"
                  className="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none 
                  focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 text-center 
                  dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800 flex items-center gap-1"
                >
                  <FaUserPlus /> Signup
                </Link>
              </>
